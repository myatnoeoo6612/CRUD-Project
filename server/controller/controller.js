...
exports.create = (req,res) => {
    //validate request
    if(!req.body){
        res.states(400).send({message: "Content can not be empty!"});
        return;
    }
...
//Update a new idetified user b user id
...
exports.delete = (req,res) => {
    ...
    Userdb.findByIdAndDelete(id)
        ...
        .catch(err=>{
            res.status(500).send({message: "Could not delete user information"})
        })
}